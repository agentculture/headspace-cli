...
uv run headspace-cli whoami  # identity from culture.yaml
uv run headspace-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `headspace/` and the `headspace-cli`
